...
const PrivacyPolicy: FC = () => (
  <Main>
    ...
    <h4>Last updated June 23, 2020</h4>

    <p>
      Thank you for choosing to be part of our community at Narrow Alley Studios (“Company”, “we”,
      ...
      with regards to your personal information, please contact us at narrowalleystudios@gmail.com.
    </p>
    <p>
      When you use our mobile application, as the case may be (the "App") and more generally, use
      any of our services (the "Services", which include the App), we appreciate that you are
      ...
      to read through it carefully, as it is important. If there are any terms in this privacy
    ...
    <article id="infocollect">
      ...
      <p>
        ...
        country, location, information about who and when you use our App and other technical
        information. This information is primarily needed to maintain the security and operation of
        our App, and for our internal analytics and reporting purposes.{' '}
      </p>
      <p>The information we collect includes:</p>
      <ol>
        <li>
          <i>Log and Usage Data.</i> Log and usage data is service-related, diagnostic usage and
          performance information our servers automatically collect when you access or use our App
          and which we record in log files. Depending on how you interact with us, this log data may
          include your IP address, device information, browser type and settings and information
          about your activity in the App (such as the date/time stamps associated with your usage,
        ...
        <li>
          ...
          tablet or other device you use to access the App. Depending on the device used, this
      ...
      <p>
        <i>
          <strong>In Short:</strong> We collect information regarding your mobile device, push
      ...
      <ul>
        ...
        <li>
          ...
          account or certain features of the App. If you wish to opt-out from receiving these types
    ...
    <article id="infouse">
      ...
      <ul>
        ...
        <li>
          ...
          to evaluate and improve our App, products, marketing and your experience. We may use and
    ...
    <article id="infoshare">
      ...
      <ul>
        ...
        <li>
          ...
          use tracking technology on the App, which will enable them to collect data on our behalf
          about how you interact with our App over time. This information may be used to, among
          other things, analyze and track data, determine the popularity of certain content, pages
          or features, and better understand online activity. Unless described in this notice, we do
          not share, sell, rent or trade any of your information with third parties for their
          promotional purposes. We have contracts in place with our data processors, which are
          designed to help safegaurd your personal information. This means that they cannot do
    ...
    <article id="whoshare">
      ...
      <p>
        ...
        and processing practices. If we have processed your data based on your consent and you wish
        to revoke your consent, please contact us using the contact details provided in the section
        below titled <a href="#contact">"HOW CAN YOU CONTACT US ABOUT THIS NOTICE?".</a>
      </p>
    ...
    <article id="3pwebsites">
      <h2>5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h2>

      <p>
        <i>
          <strong>In Short:</strong> We are not responsible for the safety of any information that
      ...
      <p>
        The App may contain advertisements from third parties that are not affiliated with us and
        ...
        other websites, services or applications that may be linked to or from the App. You should
        review the policies of such third parties and contact them directly to respond to your
        questions.
      </p>
    </article>

    <article id="inforetain">
    ...
    <article id="infosafe">
      ...
      <p>
        ...
        information to and from our App is at your own risk. You should only access the App within a
        secure environment.
      </p>
    </article>

    <article id="privacyrights">
    ...
    <article id="caresidents">
      ...
      <p>
        ...
        App, but please be aware that the data may not be completely or comprehensively removed from
        all our systems (e.g. backups, etc.).
      </p>
    </article>

    <article id="policyupdates">
    ...
    <article id="contact">
      ...
      <p>
        ...
        narrowalleystudios@gmail.com or by post to:
      </p>

      <p>
        Narrow Alley Studios <br />
        Rua Haddock Lobo, 144
        <br />
        São Paulo, São Paulo 01414-000
        <br />
        Brazil
        <br />
      </p>
